...
function App() {
  ...
  // FE-012 FIX: add [] so WebFont.load only runs once on mount, not on every render
  useEffect(() => {
    WebFont.load({
      google: {
  ...
  // FE-013 FIX: move event listeners into useEffect with cleanup to prevent
  // duplicate listeners being added on every render (memory leak)
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/account/coupons" element={
          <ProtectedRoute>
            <MyCoupons />
          </ProtectedRoute>
        } ></Route>
        ...
        <Route path="/admin/new_brand" element={
          <ProtectedRoute isAdmin={true}>
            <Dashboard activeTab={8}>
              <NewBrand />
            </Dashboard>
        ...
        <Route path="/admin/subcategory/new" element={
          <ProtectedRoute isAdmin={true}>
            <Dashboard activeTab={5}>
              <NewSubcategory />
            </Dashboard>
        ...
        <Route path="/admin/coupon/new" element={
          <ProtectedRoute isAdmin={true}>
            <Dashboard activeTab={11}>
              <NewCoupon />
            </Dashboard>
