...
const UpdateProfile = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            setAvatarPreview(user.avatar?.url || 'https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/profile-pic-male_4811a1.svg');
        }
        if (error) {
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="loginSidebar bg-primary-blue px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                        ...
                        <p className="text-gray-200 text-lg pr-2">Manage your personal information, email and account details</p>
                    </div>
                    {/* <!-- sidebar column  --> */}
