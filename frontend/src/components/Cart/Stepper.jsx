...
const Step = ({ isDesc, label, desc, index }) => {
    return (
        <div className="flex bg-white shadow px-3 sm:px-4 py-3 pb-4 rounded-sm">
            <span className="mt-2 ml-1 sm:ml-2 mr-3 sm:mr-4 h-5 w-5 flex-shrink-0 flex items-center justify-center text-xs font-medium bg-gray-100 rounded-sm text-primary-blue">{index + 1}</span>
